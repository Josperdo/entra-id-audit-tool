/*
 * Vendored dependency: @azure/msal-browser v5.16.0
 * Source:  https://www.npmjs.com/package/@azure/msal-browser (npm tarball lib/msal-browser.min.js)
 * License: MIT (Copyright Microsoft Corporation)
 * SHA-256: f9ed54dff4874f09782cd2d80f30b2feaad240f6ae3e61c6d6480b970c2401e
 *
 * Committed as a static file (not loaded from a CDN) so the dashboard's
 * Live Mode has no runtime dependency on a third-party host — see
 * Security.md "Live Dashboard Mode" for rationale. To update: download a
 * newer @azure/msal-browser release, replace the bundle below this header,
 * and update the version/SHA-256 above.
 */
